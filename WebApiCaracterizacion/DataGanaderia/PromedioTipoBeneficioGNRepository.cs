...
namespace WebApiCaracterizacion.DataGanaderia
{
    public class PromedioTipoBeneficioGNRepository
    {
        ...
        private PromediosTipoBeneficioGN Case1(SqlDataReader reader)
        {
        ...
        private PromediosTipoBeneficioGN Case2(SqlDataReader reader)
        {
            return new PromediosTipoBeneficioGN()
            {
                dato = (string)reader["dato"],
        ...
        private PromediosTipoBeneficioGN Case3(SqlDataReader reader)
        {
            return new PromediosTipoBeneficioGN()
            {
        ...
        private PromediosTipoBeneficioGN Case4(SqlDataReader reader)
        {
            return new PromediosTipoBeneficioGN()
            {
                tipo_plantilla = (string)reader["tipo_plantilla"],
