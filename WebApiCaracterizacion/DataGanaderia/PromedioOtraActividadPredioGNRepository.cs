...
namespace WebApiCaracterizacion.DataGanaderia
{
    public class PromedioOtraActividadPredioGNRepository
    {
        ...
        private PromediosOtraActividadPrediosGN MapToValue(SqlDataReader reader)
        {
        ...
        private PromediosOtraActividadPrediosGN MapToValueNullMunicipio(SqlDataReader reader)
        {
            return new PromediosOtraActividadPrediosGN()
            {
        ...
        private PromediosOtraActividadPrediosGN MapToValueGeneral(SqlDataReader reader)
        {
            return new PromediosOtraActividadPrediosGN()
            {
                tipo_plantilla = (string)reader["tipo_plantilla"],
        ...
        private PromediosOtraActividadPrediosGN MapToValueNullGeneral(SqlDataReader reader)
        {
            return new PromediosOtraActividadPrediosGN()
            {
                dato = (string)reader["dato"],
