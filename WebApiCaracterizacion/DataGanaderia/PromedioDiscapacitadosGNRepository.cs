...
namespace WebApiCaracterizacion.DataGanaderia
{
    public class PromedioDiscapacitadosGNRepository
    {
        ...
        public async Task<List<PromediosDiscapacitadosGN>> GetPromedio(string plantilla, string tipoConsulta, string fechaInicio, string fechaFin)
        {
        ...
        private PromediosDiscapacitadosGN MapToValue(SqlDataReader reader)
        {
        ...
        private PromediosDiscapacitadosGN MapToValueNullMunicipio(SqlDataReader reader)
        {
            return new PromediosDiscapacitadosGN()
            {
        ...
        private PromediosDiscapacitadosGN MapToValueGeneral(SqlDataReader reader)
        {
            return new PromediosDiscapacitadosGN()
            {
                tipo_plantilla = (string)reader["tipo_plantilla"],
        ...
        private PromediosDiscapacitadosGN MapToValueNullGeneral(SqlDataReader reader)
        {
            return new PromediosDiscapacitadosGN()
            {
                dato = (string)reader["dato"],
