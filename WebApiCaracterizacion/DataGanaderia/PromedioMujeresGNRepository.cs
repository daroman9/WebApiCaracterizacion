...
{
    public class PromedioMujeresGNRepository
    {
        private readonly string _connectionString;
        public PromedioMujeresGNRepository(IConfiguration configuration)
        {
        ...
        public async Task<List<PromediosMujeresGN>> GetPromedio(string plantilla, string tipoConsulta, string fechaInicio, string fechaFin)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("dw.IAG_Mujeres", sql))
                {
                    ...
                    var response = new List<PromediosMujeresGN>();
                    await sql.OpenAsync();
