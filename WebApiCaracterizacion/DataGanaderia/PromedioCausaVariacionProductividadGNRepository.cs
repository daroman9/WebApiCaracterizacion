...
namespace WebApiCaracterizacion.DataGanaderia
{
    public class PromedioCausaVariacionProductividadGNRepository
    {
        ...
        private PromediosCausaVariacionProductividadGN MapToValue(SqlDataReader reader)
        {
        ...
        private PromediosCausaVariacionProductividadGN MapToValueGeneral(SqlDataReader reader)
        {
            return new PromediosCausaVariacionProductividadGN()
            {
