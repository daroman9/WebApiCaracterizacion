...
{
    public class PromedioViablilidadExplotacionORRespository
    {
        private readonly string _connectionString;
        public PromedioViablilidadExplotacionORRespository(IConfiguration configuration)
        {
            _connectionString = configuration.GetConnectionString("defaultConnection");
        }

        public async Task<List<PromediosViabilidadExplotacionOR>> GetPromedio(string plantilla, string tipoConsulta, string fechaInicio, string fechaFin)
        {
            using (SqlConnection sql = new SqlConnection(_connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("dw.IM_ViabilidadExplotacion", sql))
                {
                    ...
                    var response = new List<PromediosViabilidadExplotacionOR>();
                    await sql.OpenAsync();
        ...
        private PromediosViabilidadExplotacionOR MapToValueNullGeneral(SqlDataReader reader)
        {
            return new PromediosViabilidadExplotacionOR()
            {
        ...
        private PromediosViabilidadExplotacionOR MapToValueNullMunicipio(SqlDataReader reader)
        {
            return new PromediosViabilidadExplotacionOR()
            {
        ...
        private PromediosViabilidadExplotacionOR MapToValueMunicipio(SqlDataReader reader)
        {
            return new PromediosViabilidadExplotacionOR()
            {
        ...
        private PromediosViabilidadExplotacionOR MapToValueGeneral(SqlDataReader reader)
        {
            return new PromediosViabilidadExplotacionOR()
            {
                tipo_plantilla = (string)reader["tipo_plantilla"],
