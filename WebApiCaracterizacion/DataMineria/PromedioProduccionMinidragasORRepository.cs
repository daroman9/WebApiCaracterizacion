...
{
    public class PromedioProduccionMinidragasORRepository
    {
        private readonly string _connectionString;
        public PromedioProduccionMinidragasORRepository(IConfiguration configuration)
        {
            _connectionString = configuration.GetConnectionString("defaultConnection");
        }

        public async Task<List<PromediosProduccionMinidragasOR>> GetPromedio(string plantilla, string tipoConsulta, string fechaInicio, string fechaFin)
        {
            using (SqlConnection sql = new SqlConnection(_connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("dw.IM_ProduccionMinidragas", sql))
                {
                    ...
                    var response = new List<PromediosProduccionMinidragasOR>();
                    await sql.OpenAsync();
        ...
        private PromediosProduccionMinidragasOR MapToValueNullGeneral(SqlDataReader reader)
        {
        ...
        private PromediosProduccionMinidragasOR MapToValueNullMunicipio(SqlDataReader reader)
        {
            return new PromediosProduccionMinidragasOR()
            {
                tipo_plantilla = (string)reader["tipo_plantilla"],
        ...
        private PromediosProduccionMinidragasOR MapToValueMunicipio(SqlDataReader reader)
        {
            return new PromediosProduccionMinidragasOR()
            {
                tipo_plantilla = (string)reader["tipo_plantilla"],
        ...
        private PromediosProduccionMinidragasOR MapToValueGeneral(SqlDataReader reader)
        {
            return new PromediosProduccionMinidragasOR()
            {
                tipo_plantilla = (string)reader["tipo_plantilla"],
