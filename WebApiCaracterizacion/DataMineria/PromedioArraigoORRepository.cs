...
namespace WebApiCaracterizacion.DataMineria
{
    public class PromedioArraigoORRepository
    {
        ...
        public async Task<List<PromediosArraigoOR>> GetPromedio(string tipoConsulta, string fechaInicio, string fechaFin)
        {
            using (SqlConnection sql = new SqlConnection(_connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("dw.IMO_DistribucionArraigo", sql))
                {
        ...
        private PromediosArraigoOR MapToValue(SqlDataReader reader)
        {
