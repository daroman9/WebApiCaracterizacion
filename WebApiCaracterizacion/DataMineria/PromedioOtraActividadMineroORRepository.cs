...
{
    public class PromedioOtraActividadMineroORRepository
    {
        private readonly string _connectionString;
        public PromedioOtraActividadMineroORRepository(IConfiguration configuration)
        {
            _connectionString = configuration.GetConnectionString("defaultConnection");
        }

        public async Task<List<PromediosOtraActividadMineroOR>> GetPromedio(string plantilla, string tipoConsulta, string fechaInicio, string fechaFin)
        {
            using (SqlConnection sql = new SqlConnection(_connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("dw.IM_OtraActividadMinero", sql))
                {
                    ...
                    var response = new List<PromediosOtraActividadMineroOR>();
                    await sql.OpenAsync();
        ...
        private PromediosOtraActividadMineroOR MapToValueNullGeneral(SqlDataReader reader)
        {
            return new PromediosOtraActividadMineroOR()
            {
        ...
        private PromediosOtraActividadMineroOR MapToValueNullMunicipio(SqlDataReader reader)
        {
            return new PromediosOtraActividadMineroOR()
            {
        ...
        private PromediosOtraActividadMineroOR MapToValueMunicipio(SqlDataReader reader)
        {
            return new PromediosOtraActividadMineroOR()
            {
        ...
        private PromediosOtraActividadMineroOR MapToValueGeneral(SqlDataReader reader)
        {
            return new PromediosOtraActividadMineroOR()
            {
