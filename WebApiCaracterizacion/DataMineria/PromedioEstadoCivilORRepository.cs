...
{
    public class PromedioEstadoCivilORRepository
    {
        private readonly string _connectionString;
        public PromedioEstadoCivilORRepository(IConfiguration configuration)
        {
            _connectionString = configuration.GetConnectionString("defaultConnection");
        }

        public async Task<List<PromediosEstadoCivilOR>> GetPromedio(string plantilla, string tipoConsulta, string fechaInicio, string fechaFin)
        {
            using (SqlConnection sql = new SqlConnection(_connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("dw.IM_EstadoCivil", sql))
                {
                    ...
                    var response = new List<PromediosEstadoCivilOR>();
                    await sql.OpenAsync();
        ...
        private PromediosEstadoCivilOR MapToValueNullGeneral(SqlDataReader reader)
        {
        ...
        private PromediosEstadoCivilOR MapToValueNullMunicipio(SqlDataReader reader)
        {
            return new PromediosEstadoCivilOR()
            {
        ...
        private PromediosEstadoCivilOR MapToValueMunicipio(SqlDataReader reader)
        {
            return new PromediosEstadoCivilOR()
            {
        ...
        private PromediosEstadoCivilOR MapToValueGeneral(SqlDataReader reader)
        {
            return new PromediosEstadoCivilOR()
            {
