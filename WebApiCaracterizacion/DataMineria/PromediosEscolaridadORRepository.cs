...
{
    public class PromediosEscolaridadORRepository
    {
        private readonly string _connectionString;
        public PromediosEscolaridadORRepository(IConfiguration configuration)
        {
        ...
        public async Task<List<PromediosEscolaridadOR>> GetPromedio(string plantilla, string tipoConsulta, string fechaInicio, string fechaFin)
        {
            using (SqlConnection sql = new SqlConnection(_connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("dw.IM_DistribucionEscolaridad", sql))
                {
                    ...
                    var response = new List<PromediosEscolaridadOR>();
                    await sql.OpenAsync();
        ...
        private PromediosEscolaridadOR MapToValueMunicipio(SqlDataReader reader)
        {
            return new PromediosEscolaridadOR()
            {
