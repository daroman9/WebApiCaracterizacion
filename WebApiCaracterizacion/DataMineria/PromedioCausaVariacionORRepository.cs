...
{
    public class PromedioCausaVariacionORRepository
    {
        private readonly string _connectionString;
        public PromedioCausaVariacionORRepository(IConfiguration configuration)
        {
            _connectionString = configuration.GetConnectionString("defaultConnection");
        }

        public async Task<List<PromediosCausaVariacionOR>> GetPromedio(string plantilla, string tipoConsulta, string fechaInicio, string fechaFin)
        {
            using (SqlConnection sql = new SqlConnection(_connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("dw.IM_CausaVariacionProductividad", sql))
                {
                    ...
                    var response = new List<PromediosCausaVariacionOR>();
                    await sql.OpenAsync();
        ...
        private PromediosCausaVariacionOR MapToValueNullGeneral(SqlDataReader reader)
        {
        ...
        private PromediosCausaVariacionOR MapToValueNullMunicipio(SqlDataReader reader)
        {
            return new PromediosCausaVariacionOR()
            {
        ...
        private PromediosCausaVariacionOR MapToValueMunicipio(SqlDataReader reader)
        {
            return new PromediosCausaVariacionOR()
            {
        ...
        private PromediosCausaVariacionOR MapToValueGeneral(SqlDataReader reader)
        {
            return new PromediosCausaVariacionOR()
            {
