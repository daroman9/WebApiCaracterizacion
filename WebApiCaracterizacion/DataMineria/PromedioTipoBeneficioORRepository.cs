...
{
    public class PromedioTipoBeneficioORRepository
    {
        private readonly string _connectionString;
        public PromedioTipoBeneficioORRepository(IConfiguration configuration)
        {
            _connectionString = configuration.GetConnectionString("defaultConnection");
        }

        public async Task<List<PromediosTipoBeneficioOR>> GetPromedio(string plantilla, string tipoConsulta, string fechaInicio, string fechaFin)
        {
            using (SqlConnection sql = new SqlConnection(_connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("dw.IM_TipoBeneficio", sql))
                {
                    ...
                    var response = new List<PromediosTipoBeneficioOR>();
                    await sql.OpenAsync();
        ...
        private PromediosTipoBeneficioOR MapToValueNullGeneral(SqlDataReader reader)
        {
            return new PromediosTipoBeneficioOR()
            {
        ...
        private PromediosTipoBeneficioOR MapToValueNullMunicipio(SqlDataReader reader)
        {
            return new PromediosTipoBeneficioOR()
            {
        ...
        private PromediosTipoBeneficioOR MapToValueMunicipio(SqlDataReader reader)
        {
            return new PromediosTipoBeneficioOR()
            {
        ...
        private PromediosTipoBeneficioOR MapToValueGeneral(SqlDataReader reader)
        {
            return new PromediosTipoBeneficioOR()
            {
