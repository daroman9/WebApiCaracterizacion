...
{
    public class PromedioIngresoMineroORRepository
    {
        private readonly string _connectionString;
        public PromedioIngresoMineroORRepository(IConfiguration configuration)
        {
            _connectionString = configuration.GetConnectionString("defaultConnection");
        }

        public async Task<List<PromediosIngresoMineroOR>> GetPromedio(string plantilla, string tipoConsulta, string fechaInicio, string fechaFin)
        {
            using (SqlConnection sql = new SqlConnection(_connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("dw.IM_IngresoMinero", sql))
                {
                    ...
                    var response = new List<PromediosIngresoMineroOR>();
                    await sql.OpenAsync();
        ...
        private PromediosIngresoMineroOR MapToValueNullGeneral(SqlDataReader reader)
        {
            return new PromediosIngresoMineroOR()
            {
        ...
        private PromediosIngresoMineroOR MapToValueNullMunicipio(SqlDataReader reader)
        {
            return new PromediosIngresoMineroOR()
            {
        ...
        private PromediosIngresoMineroOR MapToValueMunicipio(SqlDataReader reader)
        {
            return new PromediosIngresoMineroOR()
            {
        ...
        private PromediosIngresoMineroOR MapToValueGeneral(SqlDataReader reader)
        {
            return new PromediosIngresoMineroOR()
            {
                tipo_plantilla = (string)reader["tipo_plantilla"],
