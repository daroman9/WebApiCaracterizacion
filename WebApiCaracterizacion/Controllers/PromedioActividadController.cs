...
namespace WebApiCaracterizacion.Controllers
{
    ...
    public class PromedioActividadController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<PromediosActividad>>> GetAgro([FromQuery]string tipoConsulta, [FromQuery]string fechaInicio, [FromQuery]string fechaFin)
        {
