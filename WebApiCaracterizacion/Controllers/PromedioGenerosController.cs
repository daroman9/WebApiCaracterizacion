...
namespace WebApiCaracterizacion.Controllers
{
    ...
    public class PromedioGenerosController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<PromediosGeneros>>> GetData([FromQuery]string tipoConsulta, [FromQuery]string fechaInicio, [FromQuery]string fechaFin)
        {
