...
namespace WebApiCaracterizacion.ControllersGanaderia
{
    ...
    public class PromedioMesesCosechaGNController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<PromediosMesesCosechaGN>>> GetData([FromQuery]string plantilla, [FromQuery]string tipoConsulta, [FromQuery]string fechaInicio, [FromQuery]string fechaFin)
        {
