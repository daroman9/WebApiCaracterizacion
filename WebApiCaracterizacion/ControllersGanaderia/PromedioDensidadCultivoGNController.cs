...
namespace WebApiCaracterizacion.ControllersGanaderia
{
    ...
    public class PromedioDensidadCultivoGNController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<PromediosDensidadCultivoGN>>> GetData([FromQuery]string plantilla, [FromQuery]string tipoConsulta, [FromQuery]string fechaInicio, [FromQuery]string fechaFin)
        {
