...
namespace WebApiCaracterizacion.ControllersMineria
{
    ...
    public class PromedioVolumenProduccionORController : ControllerBase
    {
        ...
        public PromedioVolumenProduccionORController(PromedioVolumenProduccionORRepository repository)
        {
        ...
        public async Task<ActionResult<IEnumerable<PromediosVolumenProduccionOR>>> GetData([FromQuery]string plantilla, [FromQuery]string tipoConsulta, [FromQuery]string fechaInicio, [FromQuery]string fechaFin)
        {
