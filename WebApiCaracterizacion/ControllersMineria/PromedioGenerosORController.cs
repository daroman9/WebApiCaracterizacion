...
namespace WebApiCaracterizacion.ControllersMineria
{
    ...
    public class PromedioGenerosORController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<PromediosDistribicionGenerosOR>>> GetData([FromQuery]string plantilla, [FromQuery]string tipoConsulta, [FromQuery]string fechaInicio, [FromQuery]string fechaFin)
        {
