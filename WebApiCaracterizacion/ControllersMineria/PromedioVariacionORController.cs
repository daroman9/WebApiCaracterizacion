...
namespace WebApiCaracterizacion.ControllersMineria
{
    ...
    public class PromedioVariacionORController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<PromediosVariacionOR>>> GetData([FromQuery]string plantilla, [FromQuery]string tipoConsulta, [FromQuery]string fechaInicio, [FromQuery]string fechaFin)
        {
