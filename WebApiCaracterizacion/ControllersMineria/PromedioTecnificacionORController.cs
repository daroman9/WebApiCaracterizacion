...
namespace WebApiCaracterizacion.ControllersMineria
{
    ...
    public class PromedioTecnificacionORController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<PromediosTecnificacionOR>>> GetData([FromQuery]string tipoConsulta, [FromQuery]string fechaInicio, [FromQuery]string fechaFin)
        {
