...
namespace WebApiCaracterizacion.ControllersMineria
{
    ...
    public class PromedioDependenciaActividadORController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<PromediosDependenciaActividadOR>>> GetData([FromQuery]string tipoConsulta, [FromQuery]string fechaInicio, [FromQuery]string fechaFin)
        {
